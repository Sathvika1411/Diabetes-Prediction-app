...
def app(diabetes_df):
    ...
    bp=st.slider('BP',int(diabetes_df['Blood_Pressure'].min()),int(diabetes_df['Blood_Pressure'].max()))
    ...
    pedigree=st.slider('pedigree',float(diabetes_df['Pedigree_Function'].min()),float(diabetes_df['Pedigree_Function'].max()))
